...
class SpecialtyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['required','string','min:1','max:20','unique:specialties,code,except,id'],
    ...
    public function messages(): array{
        return [
            ...
            //career_id
            'sector_id.required' => 'Sector es un campo requerido',
            'sector_id.integer' => 'El tipo de dato no es valido para el campo sector'
