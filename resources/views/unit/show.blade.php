        ...
        <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0"><i class="fas fa-newspaper"></i> Ver Unidades</h3>
                    </div>
                    <div class="col-4 text-right">
                        <a href="{{ route('units.index') }}" class="btn btn-sm btn-primary"><i class="fas fa-list"></i>
                            Volver</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <h6 class="heading-small text-muted mb-4">Información de la Unidad</h6>
                <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-12">
